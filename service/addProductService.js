...
export const itemConditionList = [
  {
    ...
    title: "Brand new",
    value: "brand-new",
    description: "Still on the package (0% deduction)",
    deduction: 0,
  },
  {
    id: 2,
    title: "Like new",
    value: "like-new",
    description: "Looks like new (10% deduction)",
    deduction: 0.1,
  },
  {
    id: 3,
    title: "Lightly used",
    value: "lightly-used",
    description: "Has a small defect (15% deduction)",
    deduction: 0.15,
  },
  {
    id: 4,
    title: "Well used",
    value: "well-used",
    description: "Has a medium defect (25% deduction)",
    deduction: 0.25,
  },
  {
    id: 5,
    title: "Heavily used",
    value: "heavily-used",
    description: "Has a defect (50% deduction)",
    deduction: 0.5,
  },
  {
    id: 6,
    title: "Not good",
    value: "not-good",
    description: "Not playable (70% deduction)",
    deduction: 0.7,
  },
];
